...
///////////////////////////////////////////////////////////////////
    ...
    uvar = 432;
	res = strNE;
	expected = strTM;     try{eval("bytevar *= uvar");}
	catch(e){res = e.number}
    if (expected != res) {
    	apLogFailInfo("wrong return value",expected,res,"");
    }
    ...
    expected = 96
    if (doVerify(expected,bytevar)) {
    	apLogFailInfo("wrong return value",expected,bytevar,"269386");
    }
    bytevar = 64;
    flovar = 1.1;
	res = strNE;
...
///////////////////////////////////////////////////////////////////
    ...
    expected = "6";
    if (doVerify(expected,charvar)) {
    	apLogFailInfo("wrong return value",expected,charvar,"269405");
    }
    charvar = "5";
    numvar = 1.1;
	res = strNE;
...
///////////////////////////////////////////////////////////////////
	...
	res = strNE;
	expected = strTM;
    try{eval("intvar *= funvar");} 	catch(e){res = e.number}
    if (expected != res) {
    	apLogFailInfo("wrong return value",expected,res,"");
    }
...
///////////////////////////////////////////////////////////////////
    ...
    intvar = 1234567890
    longvar *= intvar;
    expected = long(-617283945000000000);
    if (doVerify(expected,longvar)) {
    	apLogFailInfo("wrong return value",expected,longvar,"");
    }
