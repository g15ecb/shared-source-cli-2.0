...
function VerifyType(scen, ob, sUnq, type) {
    var VersionLF="\n";
...
@end
    ...
    if (sAct != sExp)
        apLogFailInfo( scen+" failed ", sExp, sAct,"");
}
...
function tostr011() {
 ...
 @end
    ...
    VerifyType("object references",null,"null",1);
    ...
    var obUndef;
    VerifyType("undefined", obUndef,"undefined", 1);
...
//    apInitScenario("17. Browser only methods");
    ...
    VerifyType("Browser only methods--alert", window.alert, "alert", 2);
    VerifyType("Browser only methods--back", history.back, "back", 2);
    VerifyType("Browser only methods--blur", text.blur, "blur", 2);
    VerifyType("Browser only methods--clear", document.clear, "clear", 2);
    VerifyType("Browser only methods--clearTimeout", frame.clearTimeout, "clearTimeout", 2);
    VerifyType("Browser only methods--click", button.click, "click", 2);
    VerifyType("Browser only methods--close", document.close, "close", 2);
    VerifyType("Browser only methods--close", window.close, "close", 2);
    VerifyType("Browser only methods--confirm", window.confirm, "confirm", 2);
    VerifyType("Browser only methods--focus", text.focus, "focus", 2);
    VerifyType("Browser only methods--forward", history.forward, "forward", 2);
    VerifyType("Browser only methods--go", history.go, "go", 2);
    VerifyType("Browser only methods--open", document.open, "open", 2);
    VerifyType("Browser only methods--open", window.open, "open", 2);
    VerifyType("Browser only methods--prompt", window.prompt, "prompt", 2);
    VerifyType("Browser only methods--select", text.select, "select", 2);
    VerifyType("Browser only methods--setTimeout", window.setTimeout, "setTimeout", 2);
    VerifyType("Browser only methods--submit", form.submit, "submit", 2);
    VerifyType("Browser only methods--write", document.write, "write", 2);
    VerifyType("Browser only methods--writeln", document.writeln, "writeln", 2);
    */
